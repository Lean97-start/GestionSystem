export const success = {
    CREATED_DOCUMENT: {statusCode: 201, message: "Documento creado con éxito."},
    UPDATED_DOCUMENT: {statusCode: 201, message: "Documento actualizado con éxito."},
    DELETED_DOCUMENT: {statusCode: 200, message: "Documento eliminado con éxito."},
